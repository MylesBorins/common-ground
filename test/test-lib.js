...
test('common-ground: setup', function (t) {
  t.plan(1);
...
test('common-ground: convert', function (t) {
  ...
  commonGround(inFile, outFile, function (err) {
    t.error(err);
...
test('common-ground: teardown', function (t) {
  t.plan(1);
